    ...
    app.config(['$routeProvider', function ($routeProvider) {
        $routeProvider
            ...
            .when('/settings/moduleaccordion/:skin_id?', {
                templateUrl: 'index.php?route=module/journal2/tpl&tpl=settings/moduleaccordion&token=' + Journal2Config.token,
            ...
            .when('/settings/moduleproducttabs/:skin_id?', {
                templateUrl: 'index.php?route=module/journal2/tpl&tpl=settings/moduleproducttabs&token=' + Journal2Config.token,
            ...
            .when('/settings/modulestaticbanners/:skin_id?', {
                templateUrl: 'index.php?route=module/journal2/tpl&tpl=settings/modulestaticbanners&token=' + Journal2Config.token,
            ...
            .when('/module/accordion/all/:module_id?', {
                templateUrl: 'index.php?route=module/journal2/tpl&tpl=accordion/all&token=' + Journal2Config.token,
                controller: 'AccordionAllController'
            })
            .when('/module/accordion/form/:module_id?', {
                templateUrl: 'index.php?route=module/journal2/tpl&tpl=accordion/form&token=' + Journal2Config.token,
