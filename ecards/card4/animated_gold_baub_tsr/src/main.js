window.onload = function()
{
    ...
    YZI.E.preloaderBgColor = "#f1eacc";
    YZI.E.preloaderWheelColor = "0x61360c";
    YZI.E.preloaderTextColor = "#61360c";
    YZI.E.transCoverColor = "0xf1eacc";
...
YZI.E.initCard = function(_this)
{
    ...
    //logo
    _this.addLogoBtn = function(parent, x, y)
    {
        var logoBtn = YZI.E.addSprite(null, x, y, 0, "logo");
