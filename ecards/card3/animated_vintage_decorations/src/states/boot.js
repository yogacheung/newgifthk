...
YZI.Preloader.prototype =
{
    ...
    parseXmlData: function()
    {
        ...
        //parse font size
        var elName1 = "principal_font_size";//(this.game.device.desktop) ? "principal_font_size" : "mob_principal_font_size";
        var elName2 = "message_font_size";//(this.game.device.desktop) ? "message_font_size" : "mob_message_font_size";
